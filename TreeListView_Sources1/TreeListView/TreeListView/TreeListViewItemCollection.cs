...
namespace System.Windows.Forms
{
	...
	public class TreeListViewItemCollection : CollectionBase
	{
        ...
        /// Get an item in the collection
        /// </summary>
        public virtual TreeListViewItem this[string Key]
        {
            get
            {
                TreeListViewItem oItem = null;

                foreach (TreeListViewItem oTreeListViewItem in this.List)
                {
                    if (oTreeListViewItem.Name == Key)
                    {   oItem = oTreeListViewItem;
                        break;
                    }
